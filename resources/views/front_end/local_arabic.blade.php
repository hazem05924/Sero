...
<body id="page-top">
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto d-flex justify-content-center align-content-center align-items-center">
                    <li class="nav-item"><a class="nav-link" href="{{ route("home") }}"><i class="fas fa-home"></i> الرئيسية</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ url('/cms/web/login') }}"><i class="fas fa-sign-in-alt"></i> تسجيل الدخول  </a></li>                    <li class="nav-item">
                        <a class="nav-link" href="{{ route("local") }}"><img src="{{ asset('cms/assets/img/en-US.png') }}" alt="" style="width: 25px; height: 25px; border-radius: 50%;"> EN - English</a>
                    </li>
                    <!-- <div class="dropdown">
    ...
    <header class="masthead">
        ...
        <div class="warpper">
            ...
            <div class="tabs">
                <label class="tab" id="one-tab" for="one"><i class="fas fa-hotel"></i> الفنادق</label>
                <label class="tab" id="two-tab" for="two"><i class="fas fa-car"></i> مواصلات النقل</label>
            </div>
            <div class="panels col-10">
                    ...
                    <div class="add1 d-flex flex-wrap justify-content-start align-content-center align-items-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1">
                            ...
                            <div class="input-group" id="input-group">
                                <input type="text" class="form-control border-0" placeholder="2 عدد الاشخاص(s)">
                                <input type="text" class="form-control border-0" placeholder="0 عدد الاطفال(s)">
                                <input type="text" class="form-control border-0" placeholder="1 عدد الغرف(s)">
                            </div>
                        </div>
                        <div class="btn1 col-12 col-sm-12 col-md-6 col-lg-3">
                            <button type="button" class="btn p-2 w-100">بحث</button>
                        </div>
                        <!-- <div class="hoverTravel modal bg-light d-none">
                                <div class="Adults">
                                    <label for="Adults" class="text-secondary">Adults
                                            <div class="number-input d-flex">
                                                <button class="spinner decrement">-</button>
                                                <input type="number" name="Quantity[47]" value="0" class="qtyInputLoose form-control" min="0">
                                                <button class="spinner increment">+</button>
                                            </div>
                                        </label>
                                </div>
                                <div class="Children">
                                    <label for="Children" class="text-secondary">Children
                                            <div class="number-input d-flex">
                                                <button class="spinner decrement">-</button>
                                                <input type="number" name="Quantity[47]" value="0" class="qtyInputLoose form-control" min="0">
                                                <button class="spinner increment">+</button>
                                ...
                                <div class="Room">
                                    <label for="Room" class="text-secondary">Room
                                            <div class="number-input d-flex">
                                                <button class="spinner decrement">-</button>
                                                <input type="number" name="Quantity[47]" value="0" class="qtyInputLoose form-control" min="0">
                                                <button class="spinner increment">+</button>
                ...
                <div class="panel" id="two-panel">
                    <div class="add2 d-flex flex-wrap justify-content-start align-content-center align-items-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-3">
                            <label for="date-in" class="form-label">تاريخ <span>*</span></label>
                            <input type="date" name="date-in" id="date-in" class="form-control col-3">
                        </div>

                        <div class="col-12 col-sm-12 col-md-6 col-lg-3">
                            <label for="Vehicle" class="form-label">عدد المركبات  <span>*</span></label>
                            <input type="text" name="Vehicle" id="Vehicle" class="form-control col-3" placeholder="عدد المركبات ">
                        </div>

                        <div class="col-12 col-sm-12 col-md-6 col-lg-3">
                            <label for="Guests" class="form-label">عدد الركاب <span>*</span></label>
                            <input type="text" name="Guests" id="Guests" class="form-control col-3" placeholder="عدد الركاب ">
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-3">
                            <label for="Type" class="form-label">نوع المركبة</label>
                            <select class="form-control" id="Type" name="Type">
                            <option value="">اختر نوع المركبة</option>
                            <option value="">سيارة سيدان</option>
                            <option value="">سيارة جيب</option>
                            <option value="">حافلة</option>
                            <option value="">فان</option>
                        </select>
                        </div>

                        <div class="col-12 col-sm-12 col-md-6 col-lg-3">
                            <label for="Category" class="form-label">فئة المركبة</label>
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-3">
                            ...
                            <option value="">قم باختيار الموديل من</option>
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-3">
                            ...
                            <option value="">قم باختيار الموديل الى</option>
                            <option value="">2010</option>
                            <option value="">2011</option>
                            <option value="">2012</option>
                            <option value="">2013</option>
    ...
    <section class="projects-section bg-light" id="projects">
        <div class="container px-4">
            ...
            <div id="about1" class="row gx-0 mb-4 mb-lg-5 align-items-center">
                <div class="col-xl-8 col-lg-7">
                    <img class="img-fluid mb-3 mb-lg-0" src="assets/img/WhatsApp Image 2022-06-19 at 4.08.40 PM.svg" alt="..." />
                </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 mb-3 mb-md-0">
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            ...
                            <div class="small text-black-50"><a href="mailto:info@sero.com.sa">info@sero.com.sa</a></div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 mb-3 mb-md-0">
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            ...
                            <hr class="my-4 mx-auto" />
                            <div class="small text-black-50"><a href="https://goo.gl/maps/GMU7N2HUF8GMp8NHA">طريق الملك عبدالله الفرعي،المدينة المنورة</a></div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 mb-3 mb-md-0">
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            ...
                            <hr class="my-4 mx-auto" />
                            <div class="small text-black-50"><a href="tel:+966920007075">+966920007075</a></div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="modal-body text-black">
                                                    <div class="p-5">
                                                        ...
                                                        <p>تخضع شركتنا وكافة أنظمتنا للنظام العام والسياسات التابعة لدولة المنشأ وهي المملكة العربية السعودية حالياً نقبل المدفوعات عبر الإنترنت بواسطة استخدام البطاقات الإئتمانية والتي تشمل بطاقات "فيزا وماستركارد"
                                                            ويمكن الخصم منها عبر العملة المتوفرة في الخدمات عبر المنصة والتي يمكن أن تكون بالريال السعودي أو الدولار الأمريكي، وفي حال رغبتكم باستخدام خاصة الدفع الالكتروني عبر الإنترنت فإنه يجب أن يكون
                                                            هنالك تطابق وتفويضل كامل وتطابق في التفاصيل الموجودة في مُعرّف هوية العميل ومعرّف هوية صاحب البطاقة، والتي يجب أن تكون متطابقة تماماً لإجراء عمليات الشراء</p>
                                                        ...
                                                        <p>يطلب ويلتمس موقع منصة سيرو كوم من مسافريه وجميع الضيوف استشارة السلطات المحلية ببلدهم أو ببلد السفر، وتقييم قرارات حظر السفر أو التحذيرات منه أو الإعلانات المتعلقة به أو كافة الإرشادات الصادرة عن
                                                            السلطات المحلية قبل حجز السفر إلى وجهات دولية أو محلية بشكل عام، ومناطق ووجهات معينة بشكل خاص دون أدنى مسئولية على المنصة</p>

                                                        <p>عبر تقديم وبيع خدمات السفر والحجز لدول أو جهات معينة، فإن منصة سيرو كوم لا تعتبر بأي حال من الأحوال مسئولة أو متحملة للتحذير أو المخاطر في تلكم الوجهات، ولا تعتبر منصة سيرو ضامنة أو موصية بالسفر
                                                            إلى هذه الوجهات، ولا تتحمل منصة سيرو أي مسئولية عن الأضرار أو الخسائر أو التأخيرات التي قد تنجم عن عدم توفير المستندات الصحيحة والمتعلقة بالسفر والدخول والخروج أو مدة الإقامة في تكلك الوجهات</p>

                                                        <p>منصة سيرو والشركات والوكالات التابعة لها، أو موردوها غير مسئولين بأي حال من الأحوال عن الأخطاء أو الأفعال أو الإغفالات أو الإقرارات أو الضمانات او الإنتهاكات أو الإهمال الصادر من قبل أي من شركات
                                                            الطيران، أو الفنادق أو موردين الخدمات الأخرى، كما أن المنصة غير مسئولة عن أي إصاباة شخصية أو حالات الوفاة أو التلف في الممتلكات أو أي أضرار أو رسوم أو نفقات أخرى ناتجة عن ذلك، كما لا تتحمل منصة
                                                            سيرو أو أي من الشركات والوكلاءات المتعاملة معها أو أي من موردي الخدمات للمنصة أي مسئولية ولن يقوموا باسترداد الأموال في حالات حدوث أي تأخير أو إلغاء حجز أو زيادة في الضرائب، أو وجود قوة قاهرة،
                                                            أو الإضرابات وأعمال الشغب، أو أي أعمال أخرى خارجة عن السيطرة المباشرة، ولا تتحمل المنصة أي مسئولية عن أي نفقات إضافية أو أعمال التقاضي أو التأخير أو إعادة التوجيه أو أعمال الترافع إلى أي جهات
                                                            أو سلطات</p>
                                                        ...
                                                        <p>بالموافقة على الشروط والأحكام المتعلقة بأي من العمليات في هذه المنصة، فإنكم تقروون وبشكل جازم وملزم بالموافقة على الالتزام بشروط وأحكام الشراء والخدمات التي يفرضها أي مزود أو مورد للخدمة تختارون
                                                            التعامل معه، بما في ذلك على سبيل المثال لا الحصر، دفع جميع المبالغ عند استحقاقها وفقاً للقيود والقواعد المفروضة من قبل مزود أو مورد الخدمات فيما يتعلق بتوافر الخدمات واستخدام الأسعار والمنتجات
                                                            أو الخدمات في حنيها، كما إنكم تقروون بأنه قد تكون هنالك متطلبات إضافية من بعض الموردين و/ أو أطراف الطرف الثالث قد تشمل منكم التوقيع على إعفاء من المسئولية قبل تقديم الخدمة أو المشاركة بها و/أو
                                                            النشاط الذي يقدمونة، وأنكم على إدراك تام بأن أي انتهاك للشروط والأحكام والقواعد والقيود المفروضة من قبل المورد أو الموردين قد يؤدي إلى إلغاء حجزكم أو حجوزاتكم، أو حرمانكم من الوصول إلى المنتج
                                                            أو خدمات السفر والإقامة المطبقة، أو مصدارة أي أموال مدفوعة لحجزكم أو حجوزات، أو قيام منصة سيرو للخصم من حسابكم لأي تكاليف تتكبدها المنصة نتيجة لتلك الانتهاكات</p>
                                                        ...
                                                        <p>لا ولن يقوم موقع منصة سيرو أو الشركة المطورة لها بطلب أو تخزين أو مشاركة أي بيانات متعلقة بالبطاقات الإئتمانية للعملاء، أو بيانات تسجيل الدخول لحساباتهم البنكية، أو بطاقات الدفع المسبق عبر الهاتف
                                                            أو البريد الالكتروني وتحت أي ظرف</p>

                                                        <p>في حالة وجود ملاحظة على عمليات الدفع عبر بوابة الدفع الالكتروني الخاصة بنا، سيقوم فريق الحماية الخاصة بنا للتواصل معكم عبر البريد الالكتروني من العنوان التالي ccc@zowar.com.sa ، وسوف يتم طلب الحصول
                                                            على صورة للبطاقة الإئتمانية من الأمام ومن الخلف على رمز CVV للتحقق عبر الاتصال الآمن بالعنوان الالكتروني:ccc@zowar.com.sa</p>

                                                        <p>في حال تلقيكم لأي اتصال أو رسالة الكترونية من عنوان بريد الكتروني آخر يزعم أنه مرسل لكم من قبل منصة سيرو ويطلب الحصول على أي بيانات شخصية أو أمنية، فيرجى عدم الرد أبداً على ذلك البريد الالكتروني،
                                                            ويرجى تحويل الرسالة من هذا القبيل إلى بريدنا الالكتروني المتخصص وهو ccc@zowar.com.sa كما سيتوجب عليكم الحذف وبشكل مباشر وفوري لتلك الرسالة المجهولة</p>
                                                        ...
                                                        <p>سيتم تحذير المستخدم، والتأكيد عليه للموافقة بأنه سيقوم بإنشاء عمليات دفع الكترونية وبأنه سيقوم بإصدار أو إنشاء تعليمات دفع الكتروني وأنه سيقوم بتقديم بيانات بطاقته أو بطاقتها الإئتمانية أو بياناته
                                                            أو بياناتها البنكية</p>
                                                        ...
                                                        <p>يتحمل المستخدم/ العميل كامل المسئولية المتعلقة بتوفير الرصيد النقدي الكافي في البطاقة الإئتمانية/ أو الحساب البنكي الذي سيقوم باستخدامه أثناء عملية السداد للمستحقات المالية والفواتير المترتبة على
                                                            الخدمات والحجوزات التي تم اختيارها من طرفه، علماً بأن جميع المدفوعات شاملة لجميع الرسوم المتعلقة</p>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>يتوجب على حاملي تأشيرات العمرة دخول المملكة العربية السعودية ومغادرتها "جواً" عبر كل من: مطار الملك خالد الدولي بالعاصمة الرياض، مطار الملك عبدالعزيز الدولي بمدينة جدة، مطار الأمير محمد بن عبد
                                                                العزيز بالمدينة المنورة، ومطار الأمير عبدالمحسن بن عبدالعزيز بمدينة ينبع، دون العبور بأي من المطارات الأخرى بالمملكة العربية السعودية </li>
                                                            <li>يتوجب على حاملي تأشيرة العمرة الذين تم دخولهم إلى المملكة العربية السعودية عبر مطاري: الملك عبدالعزيز الدولي بجدة، والأمير محمد بن عبد العزيز الدولي بالمدينة المنورة، المغادرة فقط عبر مطاري:
                                                                الملك عبد العزيز الدولي بجدة، أو الأمير محمد بن عبدالعزيز الدولي بالمدينة المنورة، دون العبور بأي من المطارات السعودية الأخرى </li>
                                                            <li>حاملوا تأشيرات العمرة الذين تم دخول عبر مطار الملك خالد الدولي بالعاصمة الرياض، أو مطار الملك فهد الدولي بمدينة الدمام، يمكنكم المغادرة فقط من مطار الملك خالد الدولي بالعاصمة الرياض، أو مطار
                                                                الملك فهد الدولي بمدينة الدمام، أو مطار الملك عبدالعزيز الدولي بمدينة جدة أو مطار الأمير محمد بن عبدالعزيز الدولي بالمدينة المنورة دون العبور أو المرور بأي المطارات السعودية الأخرى</li>
                                                            ...
                                                            <li>يتوجب توفر جواز سفر ساري المفعول والصلاحية ولمدة لا تقل عن ستة أشهر وأن يكون جواز قابلاً لدخول المملكة العربية والسعودية ثم الوجهة التي تليها ويتوجب أن يتوفر على الأقل صفحتان خاويتان في جواز
                                                                السفر متناظرتين لأحداهما الأخرى </li>
                                                            <li>يتوجب على المعتمر التعاون الكامل مع فريق عمل منصّة سيرو لتعبئة البيانات والتأكد منها على النحو الآتي </li>
                                                            <li>المعتمر مسئول ومحاسب عن صحّة وسلامة جميع البيانات التي يقدمها إلى المنصة، وكذلك سلامة وصحّة جميع الوثائق التي سيقدمها إلى فريق عمل منصّة سيرو، بما يشمل أيضاً جميع الوثائق والبيانات التي يقوم
                                                                المعتمر بنفسه بتحميلها في الموقع الالكتروني لمنصة سيرو</li>
                                                            <li>على جميع النساء والإناث المسافرات بغرض العمرة أن يتوفر لديهن مَحْرَم، ويتوجب رفع وثائق إثبات الصلة القرابة عبر منصة سيرو أو تقديمها لفريق عمل المنصة أثناء عملية التقدم لطلب تأشيرة العمرة، ويمكن
                                                                للنساء اللاتي تتجاوزن أعمار الخمسة وأربعين سنة السفر بدون مَحرم لكن مع مجموعات منظمة، ومع ذلك سيتوجب عليهم تقديم خطاب عدم ممانعة من أحد أقربائهن من الدرجة الأول مثل الزوج، الإبن أو الأخ،
                                                                يخولها للسفر لغرض العمرة مع ذكر اسم المجموعة التي ستسافر معها، ويتوجب أن يكون هذا الخطاب موثقاً </li>
                                                            <li>بحسب الإجراءات النظامية، فإنه يتوجب على المعتمرين الذكور والذين يحملون إحدى الجنسيات التالية: (الهند، باكستان، السودان، بنغلاديش، اليمن، نيجيريا، وتشاد)، والذين تقل أعمارهم عن 40 سنة أن يكون
                                                                معهم مرافق نسائي "أنثى" على صلة قرابة من الدرجة الأولى، ويتوجب عليهم تقديم مستقدم قرابة موثق </li>
                                                            ...
                                                            <li>بعد الانتهاء من عمليات تقديم طلب التأشيرة وتأكيدها وقبولها، سيتوجب على المعتمر الاتصال بأقرب وكيل سفر خارجي محلي معتمد في بلد إقامته، والذي سيقوم باستكمال إجراءات تأشيرة السفر من القنصلية السعودية
                                                                في ذلك البلد، ويقر المعتمر هنا بالتعاون بشكل كامل مع وكيل السفر الخارجي المحلي المعتمد في بلده وذلك من خلال تقديم جميع الوثائق القانونية والضرورية المطلوبة والتي تشمل الخطابات، والتطعيمات
                                                                الطبية (في حال الحاجة) وجواز السفر وغيرها من الوثائق المطلوبة للسفر، للمعلومية فإن الفشل في هذه الإجراءات سيؤدي بدوره إلى فشل إجراءات إصدار التأشيرة، وأي تأخير يتسبب به المعتمر سيترتب عليه
                                                                تأجيل رحلة العمرة، أو حتى إلغاءها بالكلية بدون أدنى مسئولية على المنصة، ولا تتحمل منصة سيرو أدنى مسئولية، ويتوجب على المعتمر في هذه الحالة تحمل كافة النفقات والرسوم المتعلقة بتغيير تواريخ
                                                                الحجوات، أو أي غرامات متعلقة بإلغاءها </li>

                                                            <li>رسوم تأشيرة العمرة غير مسترجعة أو مستردة بأي حال من الأحوال، في حال إذا ما قرر المُعتمر إلغاء رحلة العمرة بعد صدور الرقم المرجعي للتأشيرة (موفا)، [يتم إصداره بعد نجاح طلب تأشيرة العمرة]، قبل
                                                                صدور التأشيرة، فإنه توجد إمكانية لإلغاء حزمة برنامج العمرة مع الأخذ بالاعتباشر شروط الإلغاء المتعلقة بكل مزود من (الفنادق، خدمات النقل، والطيران.... وغيرها) ويحتمل المعتمر كافة الغرامات المترتبة
                                                                على ذلك </li>
                                                            ...
                                                            <li>يتوجب على الزائرين إلى أراضي المملكة العربية السعودية، بتعاليم الدين الإسلامي الحنيف، ومراعاة الأعراف والتقاليد الإسلامية والعربية وتقاليد وأعراف المجمع السعودي، للمعلومية تطبق المملكة العربية
                                                                السعودية قوانين صارمة فيما يتعلق بتهريب المخدرات والممنوعات، وسيتعرض المخالفون والمهربون للمخدمات لعقوبات قاسية قد تصل إلى حد الإعدام، كما تمنع قوانين المملكة العربية السعودية إقامة أي تجمعات
                                                                طائفية أو عنصرية أوفرق وطوائف دينية في جميل الأحوال. </li>

                                                            <li>يتوجب على الزائرين إلى أرضاي المملكة العربية السعودية الإنصياع إلى الأنظمة والقوانين الإسلامية للملكة والضوابط والأعراف والتقاليد المتعلقة بحضارتها ومجتمعها، ويتوجب على الزائرين ارتداء الملابس
                                                                المُحتشمة واللائقة بمكانة الحرمين الشريفين والأراضي المقدسة، والمتوافقة مع القيم والثقافة الإسلامية، ويتوجب على الزائرين لغرض العمرة التركيز على أداء مناسكهم الدينية، كما يمكنهم المشاركة
                                                                بالأنشطة السياحية، ويتوجب عليهم تجب جميع أنواع الأنشطة الأخرى المخالفة أو الخارجة عن مجال هدف زيارة المملكة لأجل أدا مناسك العمرة، أو أي أنشطة تخالف الأنظمة والقوانين أو تخل بالأمن في المملكة
                                                                العربية السعودية</li>
                                                        </ul>
    ...
    <!-- Core theme JS-->
    <script src="{{ asset('cmsjs/scripts.js') }} "></script>
