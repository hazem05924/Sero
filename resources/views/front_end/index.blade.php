...
<body id="page-top">
    ...
    <!-- Travel packages-->
    <section id="packages" class="container d-flex justify-content-center justify-content-sm-evenly align-items-center align-content-center flex-wrap" style="padding: 10rem 0;">
