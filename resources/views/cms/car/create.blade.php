                  ...
                  <form id="create_form">
                      ...
                      <div class="row">
                          ...
                          <div class="form-group col-md-4">
                              ...
                              <input type="text" name="type_car" class="form-control" id="type_car"
...
{{--
                      ...
                      <div class="card-footer">
                         ...
                         <a href="{{route('cars.index')}}"><button type="button" class="btn btn-lg btn-danger"> قائمة المركبات </button></a>
                      </div>
                  </form>
              </div>
              <!-- /.card -->
