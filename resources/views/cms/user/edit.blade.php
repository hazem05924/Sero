                ...
                <div class="card card-danger">
                    ...
                    <form id="create_form">
                        ...
                        <div class="card-footer">
                            <button type="button" onclick="update({{$students->id}})" class="btn btn-lg btn-warning">تعديل</button>
                            <a href="{{route('students.index')}}"><button type="button" class="btn btn-lg btn-danger">
