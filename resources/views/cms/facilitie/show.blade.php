                        ...
                        <div class="card-body">
                            <div  class="row">
                              <div class="form-group col-md-12">
                                <label>الوصف</label>
                                <textarea class="form-control" name="discription"  rows="3" id="discription" placeholder="Enter ..." disabled> {{ $facilities->discription }}</textarea>
                              </div>
 ...
 {{-- <script>
     ...
     function update(id) {
        ...
        let formData = new FormData();
            ...
            formData.append('discription',document.getElementById('discription').files[0]);
